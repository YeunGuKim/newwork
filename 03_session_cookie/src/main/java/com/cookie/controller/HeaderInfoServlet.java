 ...
 */
//@WebServlet(urlPatterns = "/headerdata.do")
public class HeaderInfoServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//HttpRequestHeader정보가져오기
		//HttpServletRequest에 해당정보가 저장되어있음
		...
		//web.xml에 등록된 init-param값 가져오기
		String initData=getInitParameter("headerServlet");
		System.out.println("headerServlet : "+initData);
