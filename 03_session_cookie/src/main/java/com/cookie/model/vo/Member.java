...
public class Member {
	...
	@Override
	public int hashCode() {
		return Objects.hash(address, age, email, enrollDate, gender, hobby, memberName, memberId, memberPwd, phone);
	}
	...
	public boolean equals(Object obj) {
		...
		return Objects.equals(address, other.address) && age == other.age && Objects.equals(email, other.email)
				...
				&& Objects.equals(hobby, other.hobby) && Objects.equals(memberName, other.memberName)
				&& Objects.equals(memberId, other.memberId) && Objects.equals(memberPwd, other.memberPwd)
				&& Objects.equals(phone, other.phone);
	}

	@Override
	public String toString() {
		return "Member [memberId=" + memberId + ", memberPwd=" + memberPwd + ", mamberName=" + memberName + ", gender="
